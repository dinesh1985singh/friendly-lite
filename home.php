<?php
/**
 * Template file for listing blog posts on a static page.
 *
 * If a user sets a static page for posts page under
 * Settings->Reading->Front page displays.
 * This is the tempate that being used to render blog posts.
 * Fallback to index.php template if does not exit.
 *
				...
				if ( have_posts() ) :
					...
					if ( is_home() && ! is_front_page() ) :
						...
						<header class="page-header">
							<h1 id="page-title"><?php echo single_post_title(); ?></h1>
						</header>
						<?php
					endif;
